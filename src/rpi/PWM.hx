...
package rpi;
@:pythonImport("RPi.GPIO", "PWM") extern class PWM {
	/**
		Change the duty cycle
		dutycycle - between 0.0 and 100.0
	**/
	public function ChangeDutyCycle(args:haxe.extern.Rest<Dynamic>):Dynamic;
	/**
		Change the frequency
		frequency - frequency in Hz (freq > 1.0)
	**/
	public function ChangeFrequency(args:haxe.extern.Rest<Dynamic>):Dynamic;
